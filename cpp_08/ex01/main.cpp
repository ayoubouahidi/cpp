...
int main()
{
    try{
        ...
        // test addRange
        Span sp_addRange(20);
        sp_addRange.addRange(sp.get_first(), sp.get_last());
        int longest_addRange = sp_addRange.longestSpan();
        int shortest_addRange = sp_addRange.shortestSpan();
        std::cout << "longest : " << longest_addRange << std::endl;
        std::cout << "shortest : " << shortest_addRange << std::endl;
