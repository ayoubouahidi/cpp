...
ClapTrap::ClapTrap(const std::string name, int points, int Energy_points, int Attack_damage):name(name), points(points), Energy_points(Energy_points), Attack_damage(Attack_damage)
{
